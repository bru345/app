...
class InterpolatedPlayer extends Player {
  constructor(opts) {
    ...
    this.actionBinaryInterpolants = {
      ...
      swordIdleSide: new BinaryInterpolant(() => this.hasAction('swordIdleSide'), avatarInterpolationTimeDelay, avatarInterpolationNumFrames),
    };
    ...
    this.actionBinaryTimeSteps = {
      ...
      swordIdleSide: new FixedTimeStep(timeDiff => {this.actionBinaryInterpolants.swordIdleSide.snapshot(timeDiff);}, avatarInterpolationFrameRate),
    };
    ...
    this.actionInterpolants = {
      ...
      swordIdleSide: new InfiniteActionInterpolant(() => this.actionBinaryInterpolants.swordIdleSide.get(), 0),
...
class UninterpolatedPlayer extends Player {
  constructor(opts) {
    ...
    this.actionInterpolants = {
      ...
      swordIdleSide: new InfiniteActionInterpolant(() => this.hasAction('swordIdleSide'), 0),
    };
    this.actionInterpolantsArray = Object.keys(this.actionInterpolants).map(k => this.actionInterpolants[k]);
